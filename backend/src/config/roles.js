export const PERMISSION_DEFINITIONS = [
  ...
  { key: "categories:read", module: "Bookkeeping", group: "Categories", label: "Read categories" },
  { key: "categories:create", module: "Bookkeeping", group: "Categories", label: "Create categories" },
  { key: "categories:update", module: "Bookkeeping", group: "Categories", label: "Update categories" },
  { key: "categories:delete", module: "Bookkeeping", group: "Categories", label: "Delete categories" },
  ...
  { key: "tasks:read", module: "Operations CRM", group: "Tasks", label: "Read tasks" },
