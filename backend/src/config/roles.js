export const PERMISSION_DEFINITIONS = [
  ...
  { key: "clientsNotes:create", module: "Bookkeeping", group: "Client Notes", label: "Add client notes" },
  { key: "clientsNotes:update", module: "Bookkeeping", group: "Client Notes", label: "Edit any note (other authors)" },
  { key: "clientsNotes:delete", module: "Bookkeeping", group: "Client Notes", label: "Delete any note (other authors)" },
