...
export async function ensureTransactionsIndexes() {
  ...
  await Promise.all([
    ...
    collection.createIndex({ clientId: 1, createdBy: 1, createdAt: -1 }),
    collection.createIndex({ clientId: 1, createdBy: 1, llmProcessedAt: -1 }),
    collection.createIndex({ clientId: 1, createdBy: 1, categorizedAt: -1 }),
